                            ...
                            <div className="card-body text-white">
                                <form autoComplete='off' onSubmit={submitHandler}>
                                    ...
                                    <div className="form-group mt-2">
                                        ...
                                        <select name="gender" id="gender" className='select' style={{"marginLeft" : "10px"}} ref={fgender}>
                                    ...
                                    <div className="form-group mt-2">
                                        <label htmlFor='mobile'>Problem<span className='text-danger'>*</span></label>
                                        <textarea name="" id="" cols="30" rows="5" className='form-control' ref={fproblem}></textarea>
                                    </div>
                                    <div className="form-group mt-2 ">
